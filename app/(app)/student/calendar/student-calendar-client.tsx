...
import type { StudentAdhocReservation, StudentCalendarSection, StudentInClassReservation } from "@/lib/reservations/types";
...
export default function StudentCalendarClient() {
  ...
  const [sections, setSections] = useState<StudentCalendarSection[]>([]);
  const [adhoc, setAdhoc] = useState<StudentAdhocReservation[]>([]);
  const [inClass, setInClass] = useState<StudentInClassReservation[]>([]);
